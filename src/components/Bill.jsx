...
const Bill = () => {
    const mobileNumber = "062-384-4415";
    ...
    const generateQR = (amount) => {
        ...
        // Convert to SVG QR Code with increased size
        ...
        Swal.fire({
            ...
            html: `
                <div style="width: 100%; max-width: 300px; margin: auto;">
                    <img src="data:image/svg+xml;utf8,${encodeURIComponent(svg)}" style="width: 100%; height: auto;"/>
                </div>
